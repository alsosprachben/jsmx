...
#define CASE_NAME "test262/concat/S15.5.4.6_A1_T7"
...
main(void)
{
	...
	GENERATED_TEST_ASSERT(generated_measure_and_concat(&out, storage,
			...
			"failed concat(undefined)");
	GENERATED_TEST_ASSERT(generated_expect_utf8_string(&out,
			"legoundefined", SUITE, CASE_NAME,
			"\"lego\".concat(undefined)") == GENERATED_TEST_PASS,
			SUITE, CASE_NAME, "unexpected concat(undefined) result");
