...
#define CASE_NAME "test262/slice/this-value-not-obj-coercible"
...
main(void)
{
	...
	GENERATED_TEST_ASSERT(jsmethod_string_slice(&out,
			jsmethod_value_undefined(), 1, jsmethod_value_number(0.0), 0,
	...
	GENERATED_TEST_ASSERT(error.kind == JSMETHOD_ERROR_TYPE, SUITE, CASE_NAME,
			...
			(int)error.kind);
	GENERATED_TEST_ASSERT(jsmethod_string_slice(&out, jsmethod_value_null(), 1,
