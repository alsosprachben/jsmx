...
#define CASE_NAME "test262/padStart/observable-operations"
...
main(void)
{
	...
	GENERATED_TEST_ASSERT(generated_measure_and_pad(&out, storage,
			...
			1, fill_string_value, jsmethod_string_pad_start_measure, jsmethod_string_pad_start,
			&error) == 0, SUITE, CASE_NAME,
			"failed observable padStart");
	GENERATED_TEST_ASSERT(generated_expect_utf8_string(&out,
			"defdefdeabc", SUITE, CASE_NAME,
