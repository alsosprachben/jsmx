...
#define CASE_NAME "test262/padStart/exception-not-object-coercible"
...
main(void)
{
	...
	GENERATED_TEST_ASSERT(jsmethod_string_pad_start(&out, jsmethod_value_null(), 0,
	...
	GENERATED_TEST_ASSERT(jsmethod_string_pad_start(&out, jsmethod_value_undefined(), 0,
			jsmethod_value_undefined(), 0, jsmethod_value_undefined(),
			&error) == -1, SUITE, CASE_NAME,
	...
	GENERATED_TEST_ASSERT(jsmethod_string_pad_start(&out,
