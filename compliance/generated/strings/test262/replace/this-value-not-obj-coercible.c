...
#define CASE_NAME "test262/replace/this-value-not-obj-coercible"
...
main(void)
{
	 ...
	 * test/built-ins/String/prototype/replace/this-value-not-obj-coercible.js
	 *
	 * This idiomatic flattened translation preserves the runtime
	 * RequireObjectCoercible(this) checks. The upstream typeof metadata
	 * assertion is intentionally omitted.
	 */

	GENERATED_TEST_ASSERT(jsmethod_string_replace(&out,
