...
#define CASE_NAME "test262/intl402-toLocaleLowerCase-special_casing_Turkish"
...
main(void)
{
	 ...
	 * test/intl402/String/prototype/toLocaleLowerCase/special_casing_Turkish.js
	 *
	 * This fixture exercises the Turkic locale-conditional lowercase path
	 * through `jsmethod_string_to_locale_lower_case(..., "tr")`.
	 */
