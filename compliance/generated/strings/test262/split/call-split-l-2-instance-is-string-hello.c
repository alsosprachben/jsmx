...
#define CASE_NAME "test262/split/call-split-l-2-instance-is-string-hello"

int
main(void)
{
	static const uint16_t receiver_text[] = {'h','e','l','l','o'};
	uint16_t receiver_storage[GENERATED_LEN(receiver_text)];
	static const char *expected[] = {"he", ""};
	...
	GENERATED_TEST_ASSERT(jsmethod_string_split(
			...
			1, jsmethod_value_string_utf8((const uint8_t *)"l", 1),
