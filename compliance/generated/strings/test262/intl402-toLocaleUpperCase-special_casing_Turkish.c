...
#define CASE_NAME "test262/intl402-toLocaleUpperCase-special_casing_Turkish"

typedef struct tr_case_s {
...
run_case(const tr_case_t *tc)
{
	...
	if (jsmethod_string_to_locale_upper_case(&value,
			...
			1, jsmethod_value_string_utf8((const uint8_t *)"tr", 2),
...
main(void)
{
	 ...
	 * test/intl402/String/prototype/toLocaleUpperCase/special_casing_Turkish.js
	 *
	 * This fixture exercises the locale-conditional Turkic uppercasing path
	 * through `jsmethod_string_to_locale_upper_case(..., "tr")`.
	 */
