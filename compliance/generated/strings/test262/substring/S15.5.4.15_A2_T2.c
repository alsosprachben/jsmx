...
#define CASE_NAME "test262/substring/S15.5.4.15_A2_T2"
...
main(void)
{
	...
	GENERATED_TEST_ASSERT(jsmethod_string_substring(&out,
			...
			SUITE, CASE_NAME, "failed substring(NaN, Infinity)");
	GENERATED_TEST_ASSERT(generated_expect_accessor_string(&out, expected, 23,
			SUITE, CASE_NAME, "substring(NaN, Infinity)") ==
			GENERATED_TEST_PASS, SUITE, CASE_NAME,
			"unexpected substring(NaN, Infinity)");
