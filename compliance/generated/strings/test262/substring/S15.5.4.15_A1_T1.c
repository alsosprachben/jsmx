...
#define CASE_NAME "test262/substring/S15.5.4.15_A1_T1"
...
main(void)
{
	...
	GENERATED_TEST_ASSERT(jsmethod_string_substring(&out,
			...
			SUITE, CASE_NAME, "failed lowered substring(false, true)");
	GENERATED_TEST_ASSERT(generated_expect_accessor_string(&out, expected, 1,
			SUITE, CASE_NAME, "lowered substring(false, true)") ==
			GENERATED_TEST_PASS, SUITE, CASE_NAME,
			"unexpected lowered substring(false, true)");
