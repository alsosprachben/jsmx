...
#define CASE_NAME "test262/substring/this-value-not-obj-coercible"
...
main(void)
{
	...
	GENERATED_TEST_ASSERT(jsmethod_string_substring(&out,
			jsmethod_value_undefined(), 1, jsmethod_value_number(0.0), 1,
	...
	GENERATED_TEST_ASSERT(error.kind == JSMETHOD_ERROR_TYPE, SUITE, CASE_NAME,
			...
			(int)error.kind);
	GENERATED_TEST_ASSERT(jsmethod_string_substring(&out, jsmethod_value_null(),
			1, jsmethod_value_number(0.0), 1, jsmethod_value_number(1.0),
