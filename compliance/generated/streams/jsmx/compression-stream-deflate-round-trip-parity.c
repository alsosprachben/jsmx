...
#define CASE_NAME "jsmx/compression-stream-deflate-round-trip-parity"
...
main(void)
{
	...
	GENERATED_TEST_ASSERT(
			compressed_len >= 1 && compressed[0] == 0x78,
			SUITE, CASE_NAME,
			"compressed output must begin with zlib CMF 0x78");
