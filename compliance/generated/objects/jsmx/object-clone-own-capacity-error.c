...
#define CASE_NAME "jsmx/object-clone-own-capacity-error"
...
main(void)
{
	 ...
	 * compliance/js/objects/jsmx/object-clone-own-capacity-error.js
	 *
	 * This idiomatic flattened translation exercises the explicit ENOBUFS
	 * capacity contract on jsval_object_clone_own().
	 */
	...
	out = jsval_null();
	errno = 0;
	GENERATED_TEST_ASSERT(jsval_object_clone_own(&region, src, 1, &out) == -1,
			SUITE, CASE_NAME,
