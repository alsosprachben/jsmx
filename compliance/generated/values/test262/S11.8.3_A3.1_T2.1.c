...
#define SUITE "values"
#define CASE_NAME "test262/S11.8.3_A3.1_T2.1"
...
main(void)
{
	 ...
	 * test/language/expressions/less-than-or-equal/S11.8.3_A3.1_T2.1.js
	 *
	...
	GENERATED_TEST_ASSERT(jsval_less_equal(&region, jsval_bool(1),
	...
	GENERATED_TEST_ASSERT(jsval_less_equal(&region, jsval_number(1.0),
