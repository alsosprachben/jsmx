...
#define SUITE "values"
#define CASE_NAME "test262/S11.8.1_A3.1_T2.5"
...
main(void)
{
	 ...
	 * boolean/string numeric-relational checks. The wrapper-object checks are
	...
	GENERATED_TEST_ASSERT(jsval_less_than(&region, jsval_bool(1), one_string,
	...
	GENERATED_TEST_ASSERT(jsval_less_than(&region, one_string, jsval_bool(1),
			&result) == 0, SUITE, CASE_NAME,
