...
#define SUITE "values"
#define CASE_NAME "test262/S11.10.2_A3_T2.1"
...
main(void)
{
	 ...
	 * test/language/expressions/bitwise-xor/S11.10.2_A3_T2.1.js
	 *
	...
	GENERATED_TEST_ASSERT(jsval_bitwise_xor(&region, jsval_number(1.0),
