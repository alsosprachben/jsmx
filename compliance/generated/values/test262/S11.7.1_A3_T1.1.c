...
#define SUITE "values"
#define CASE_NAME "test262/S11.7.1_A3_T1.1"
...
main(void)
{
	 ...
	 * test/language/expressions/left-shift/S11.7.1_A3_T1.1.js
	 *
	 * This is an idiomatic slow-path translation. Primitive operands lower
	 * directly through jsval_shift_left, and the boxed Boolean cases are
	 * preserved through an explicit translator-emitted boxed-wrapper coercion
	 * helper outside jsmx.
	 */

	jsval_region_init(&region, storage, sizeof(storage));
	GENERATED_TEST_ASSERT(jsval_shift_left(&region, jsval_bool(1), jsval_bool(1),
