...
#define SUITE "values"
#define CASE_NAME "test262/S11.7.3_A3_T1.1"
...
main(void)
{
	 ...
	 * test/language/expressions/unsigned-right-shift/S11.7.3_A3_T1.1.js
	 *
	 * This is an idiomatic slow-path translation. Primitive operands lower
	 * directly through jsval_shift_right_unsigned, and the boxed Boolean cases
	 * are preserved through an explicit translator-emitted boxed-wrapper
	 * coercion helper outside jsmx.
	 */
	...
	GENERATED_TEST_ASSERT(jsval_shift_right_unsigned(&region,
			generated_slow_boxed_boolean(1), jsval_bool(1), &result) == 0,
			SUITE, CASE_NAME, "failed to lower boxed true >>> true");
	GENERATED_TEST_ASSERT(generated_expect_number(&region, result, 0.0, SUITE,
	...
	GENERATED_TEST_ASSERT(jsval_shift_right_unsigned(&region,
			generated_slow_boxed_boolean(1), generated_slow_boxed_boolean(1),
