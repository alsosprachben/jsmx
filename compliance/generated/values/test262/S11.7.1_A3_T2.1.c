...
#define SUITE "values"
#define CASE_NAME "test262/S11.7.1_A3_T2.1"
...
main(void)
{
	 ...
	 * test/language/expressions/left-shift/S11.7.1_A3_T2.1.js
	 *
	 * This is an idiomatic slow-path translation. Primitive operands lower
	 * directly through jsval_shift_left, and the boxed Boolean/Number cases are
	 * preserved through explicit translator-emitted boxed-wrapper coercion
	 * helpers outside jsmx.
	 */

	jsval_region_init(&region, storage, sizeof(storage));
	GENERATED_TEST_ASSERT(jsval_shift_left(&region, jsval_bool(1),
	...
	GENERATED_TEST_ASSERT(jsval_shift_left(&region, jsval_number(1.0),
	...
	GENERATED_TEST_ASSERT(jsval_shift_left(&region, generated_slow_boxed_boolean(1),
			jsval_number(1.0), &result) == 0, SUITE, CASE_NAME,
	...
	GENERATED_TEST_ASSERT(jsval_shift_left(&region, generated_slow_boxed_number(1.0),
			jsval_bool(1), &result) == 0, SUITE, CASE_NAME,
