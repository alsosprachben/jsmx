...
#define SUITE "values"
#define CASE_NAME "test262/S11.6.2_A3_T2.1"
...
main(void)
{
	 ...
	 * test/language/expressions/subtraction/S11.6.2_A3_T2.1.js
	 *
	 * This idiomatic flattened translation preserves the primitive boolean
	 * and number subtraction cases. The wrapper-object cases are intentionally
	 * omitted at the current flattened layer.
	 */

	jsval_region_init(&region, storage, sizeof(storage));
	GENERATED_TEST_ASSERT(jsval_subtract(&region, jsval_bool(1), jsval_number(1.0),
	...
	GENERATED_TEST_ASSERT(jsval_subtract(&region, jsval_number(1.0), jsval_bool(1),
			&result) == 0, SUITE, CASE_NAME,
