...
#define SUITE "values"
#define CASE_NAME "test262/S11.9.4_A8_T4"
...
main(void)
{
	 ...
	 *
	 * This idiomatic flattened translation preserves the primitive null and
	 * undefined cross-type checks. The object comparisons in CHECK#9 and
	 * CHECK#10 are intentionally omitted.
	 */
