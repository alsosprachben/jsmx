...
#define SUITE "values"
#define CASE_NAME "test262/S11.8.4_A3.1_T2.1"
...
main(void)
{
	...
	GENERATED_TEST_ASSERT(jsval_greater_equal(&region, jsval_bool(1),
	...
	GENERATED_TEST_ASSERT(jsval_greater_equal(&region, jsval_number(1.0),
