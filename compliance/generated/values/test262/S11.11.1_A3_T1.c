...
#define SUITE "values"
#define CASE_NAME "test262/S11.11.1_A3_T1"
...
main(void)
{
	 ...
	 * test/language/expressions/logical-and/S11.11.1_A3_T1.js
	 *
	...
	result = generated_logical_and(&region, jsval_bool(0), jsval_bool(0));
	GENERATED_TEST_ASSERT(generated_expect_value_strict_eq(&region, result,
			jsval_bool(0), SUITE, CASE_NAME,
