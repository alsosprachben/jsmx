...
#define SUITE "values"
#define CASE_NAME "test262/S11.9.2_A6.1"
...
main(void)
{
	 ...
	 * test/language/expressions/does-not-equals/S11.9.2_A6.1.js
	 *
	...
	GENERATED_TEST_ASSERT(generated_expect_abstract_ne(&region,
			jsval_undefined(), jsval_undefined(), 0, SUITE, CASE_NAME,
