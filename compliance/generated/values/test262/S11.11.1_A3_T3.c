...
#define SUITE "values"
#define CASE_NAME "test262/S11.11.1_A3_T3"
...
main(void)
{
	 ...
	 * test/language/expressions/logical-and/S11.11.1_A3_T3.js
	 *
	 * This idiomatic flattened translation preserves the primitive string
	 * cases. The String-object case is intentionally omitted above the current
	...
	GENERATED_TEST_ASSERT(generated_expect_value_string(&region, result,
			(const uint8_t *)"", 0, SUITE, CASE_NAME,
