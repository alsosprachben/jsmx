...
#define SUITE "values"
#define CASE_NAME "test262/S11.7.3_A3_T2.1"
...
main(void)
{
	 ...
	 * test/language/expressions/unsigned-right-shift/S11.7.3_A3_T2.1.js
	 *
	 * This is an idiomatic slow-path translation. Primitive operands lower
	 * directly through jsval_shift_right_unsigned, and the boxed
	 * Boolean/Number cases are preserved through explicit translator-emitted
	 * boxed-wrapper coercion helpers outside jsmx.
	 */

	jsval_region_init(&region, storage, sizeof(storage));
	GENERATED_TEST_ASSERT(jsval_shift_right_unsigned(&region, jsval_bool(1),
	...
	GENERATED_TEST_ASSERT(jsval_shift_right_unsigned(&region, jsval_number(1.0),
	...
	GENERATED_TEST_ASSERT(jsval_shift_right_unsigned(&region,
			generated_slow_boxed_boolean(1), jsval_number(1.0), &result) == 0,
			SUITE, CASE_NAME, "failed to lower boxed true >>> 1");
	GENERATED_TEST_ASSERT(generated_expect_number(&region, result, 0.0, SUITE,
	...
	GENERATED_TEST_ASSERT(jsval_shift_right_unsigned(&region,
			generated_slow_boxed_number(1.0), jsval_bool(1), &result) == 0,
			SUITE, CASE_NAME, "failed to lower boxed 1 >>> true");
	GENERATED_TEST_ASSERT(generated_expect_number(&region, result, 0.0, SUITE,
			CASE_NAME, "boxed 1 >>> true") == GENERATED_TEST_PASS, SUITE,
			CASE_NAME, "unexpected result for boxed 1 >>> true");
	GENERATED_TEST_ASSERT(jsval_shift_right_unsigned(&region,
			generated_slow_boxed_boolean(1), generated_slow_boxed_number(1.0),
	...
	GENERATED_TEST_ASSERT(jsval_shift_right_unsigned(&region,
			generated_slow_boxed_number(1.0), generated_slow_boxed_boolean(1),
			&result) == 0, SUITE, CASE_NAME,
