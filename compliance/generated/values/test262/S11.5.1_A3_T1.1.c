...
#define SUITE "values"
#define CASE_NAME "test262/S11.5.1_A3_T1.1"
...
main(void)
{
	 ...
	 * test/language/expressions/multiplication/S11.5.1_A3_T1.1.js
	 *
	 * This idiomatic flattened translation preserves the primitive boolean
	 * multiplication case. The wrapper-object cases are intentionally omitted
	 * at the current flattened layer.
	 */

	jsval_region_init(&region, storage, sizeof(storage));
	GENERATED_TEST_ASSERT(jsval_multiply(&region, jsval_bool(1), jsval_bool(1),
