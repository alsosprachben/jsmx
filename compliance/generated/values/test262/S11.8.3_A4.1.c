...
#define SUITE "values"
#define CASE_NAME "test262/S11.8.3_A4.1"
...
main(void)
{
	 ...
	 * test/language/expressions/less-than-or-equal/S11.8.3_A4.1.js
	 *
	 * This is a direct flattened translation of the NaN-false less-than-or-
	 * equal edge cases through jsval_less_equal.
	 */

	jsval_region_init(&region, storage, sizeof(storage));
	GENERATED_TEST_ASSERT(jsval_less_equal(&region, jsval_number(NAN),
