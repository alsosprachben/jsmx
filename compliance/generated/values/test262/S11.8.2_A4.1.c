...
#define SUITE "values"
#define CASE_NAME "test262/S11.8.2_A4.1"
...
main(void)
{
	 ...
	 * test/language/expressions/greater-than/S11.8.2_A4.1.js
	 *
	 * This is a direct flattened translation of the NaN-false greater-than
	 * edge cases through jsval_greater_than.
	 */

	jsval_region_init(&region, storage, sizeof(storage));
	GENERATED_TEST_ASSERT(jsval_greater_than(&region, jsval_number(NAN),
