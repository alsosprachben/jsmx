...
#define SUITE "values"
#define CASE_NAME "test262/S11.10.3_A3_T2.1"
...
main(void)
{
	 ...
	 * test/language/expressions/bitwise-or/S11.10.3_A3_T2.1.js
	 *
	...
	GENERATED_TEST_ASSERT(jsval_bitwise_or(&region, jsval_bool(1),
	...
	GENERATED_TEST_ASSERT(jsval_bitwise_or(&region, jsval_number(1.0),
