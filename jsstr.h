...
#define declare_jsstr32(__varname, __str) jsstr_t __varname = jsstr32_init_from_str(__str)
...
#define declare_jsstr16(__varname, __str) jsstr16_t __varname = jsstr16_init_from_str(__str)
...
#define declare_jsstr8(__varname, __str) jsstr8_t __varname = jsstr8_init_from_str(__str)
